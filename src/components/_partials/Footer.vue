  ...
  <footer class="footer">
    <div class="container">
      <div class="content has-text-centered">
        <p style="color:white;">
          Copyright 2017 &copy; <router-link :to="{ name: 'Home' }" tag="a" exact><strong>ColorElephant Lda</strong></router-link>. Made with ❤ &amp; ☕ <br />
          <a href="https://github.com/ColorElephant" target="_blank" title="Follow ColorElephant on Github">
          ...
          <a href="http://twitter.com/ColorElephant" target="_blank" title="Follow ColorElephant on Twitter">
          ...
          <a href="https://www.linkedin.com/company/2879826/" target="_blank" title="Find ColorElephant on LinkedIn">
          ...
          <a href="https://www.facebook.com/ColorElephant/" target="_blank" title="Like ColorElephant on Facebook">
          ...
          <!-- <a href="https://bulma.io"><img src="https://bulma.io/images/made-with-bulma--white.png" alt="Made with Bulma" width="128" height="24"></a> -->
        </p>
      </div>
    </div>
  </footer>
